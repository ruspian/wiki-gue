...
<Callout type="error" emoji="⛔">
  {" "}
  **Peringatan Performa:** Efek backdrop-blur itu berat itungannya buat browser.
  Jangan dipake kebanyakan di HP kentang, nanti scroll-nya jadi patah-patah
  (lag). Pake secukupnya aja di Navbar atau Modal.{" "}
</Callout>
