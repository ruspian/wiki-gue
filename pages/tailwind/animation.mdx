...
Website yang diem mulu itu ngebosenin. Kadang kita butuh elemen yang gerak dikit, misal pas lagi _Loading_ atau notifikasi masuk.
...
```jsx
<div className="animate-pulse bg-gray-300 w-full h-32 rounded-lg"></div>
```
...
<Callout type="success" emoji="🎉">
  {" "}
  **Kesimpulan:** Tailwind itu bukan penjara. Lo bebas nambahin warna, font,
  atau animasi apa aja lewat file Config. Jadi web lo gak bakal kelihatan
  "Pasaran".{" "}
</Callout>
